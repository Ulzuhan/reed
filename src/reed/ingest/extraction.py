...
1. PDF, Markdown and plain-text parsers, section-aware chunking, and embedding
   input composed as ``Title: <filename>\\nSection: <section>\\n\\n<text>``.
   Reed 0.3 shipped this scheme without recording it; Reed 0.2 embedded the raw
   chunk text and is therefore *not* this version.
"""
